  ...
  const farmers = useMemo(() => {
    return [
      ...sampleFarmers,
      {
        ...
        email: 'michael@savannagrains.com',
        phone: '+254 756 789 012',
        location_address: 'Trans Nzoia County, Kenya',
        farm_size: '200 acres',
      ...
      },
      {
        ...
        location_address: 'Naivasha, Kenya',
        farm_size: '15 acres',
      ...
      },
      {
        ...
        email: 'joseph@valleyfresh.com',
        phone: '+254 778 901 234',
        location_address: 'Uasin Gishu County, Kenya',
        farm_size: '80 acres',
      ...
      },
      {
        ...
        email: 'fatuma@coastalharvest.com',
        phone: '+254 789 012 345',
        location_address: 'Kilifi County, Kenya',
        farm_size: '25 acres',
